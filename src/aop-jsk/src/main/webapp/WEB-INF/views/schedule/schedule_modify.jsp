...
<head>
	<meta charset="UTF-8">
	<title>정보 수정</title>
	<link rel="stylesheet" href="../resources/schedule.css" type="text/css"></link>
</head>
<body>
	<div align=center>
		<header>일정 수정</header>
		...
		<table>
			...
			<tr><th>설명</th><td><input type="text" name="schedule_desc" value="${schedule.schedule_desc}" style ="height:50px"></td></tr>
