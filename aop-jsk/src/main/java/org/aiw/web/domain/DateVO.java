...
import org.aiw.web.persistence.ScheduleDTO;
...
public class DateVO {
	...
	public Map<String, Integer> today_info(DateVO dateData) {
		// 날짜 캘린더 함수에 삽입.
	...
	public DateVO(String year, String month, String date, String value, ScheduleDTO[] schedule_data_arr) {
